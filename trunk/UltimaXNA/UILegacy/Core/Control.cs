...
namespace UltimaXNA.UILegacy
{
    ...
    public class Control : IControl
    {
        ...
        public int ActivePage
        {
            ...
            set
            {
                ...
                if (UserInterface.KeyboardFocusControl != null)
                {
                    if (Controls.Contains(UserInterface.KeyboardFocusControl))
                    {
                        if (UserInterface.KeyboardFocusControl.Page == 0)
                            UserInterface.AnnounceNewKeyboardHandler(UserInterface.KeyboardFocusControl);
                        else
                            UserInterface.AnnounceNewKeyboardHandler(null);
                    }
                }
                ...
                foreach (Control c in Controls)
                {
                    ...
                    {
                        UserInterface.AnnounceNewKeyboardHandler(c);
                    }
                }
            }
        }
        ...
        public void ItemDrop(Item item, int x, int y)
        {
            itemDrop(item, x, y);
        }
        ...
        protected virtual void itemDrop(Item item, int x, int y)
        {
