...
namespace UltimaXNA.UILegacy.ClientsideGumps
{
    ...
    class SelectServerGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            AddControl(new HtmlGump(this, 1, 158, 72, 200, 20, 0, 0, Data.StringList.Entry(1044579)));
            ...
            AddControl(new TextLabelAscii(this, 2, 166, 143, 2017, 2, Data.StringList.Entry(3000053) + "..."));
