...
namespace UltimaXNA.Input
{
    ...
    public class WndProc : MessageHook
    {
        ...
        {
            invokeMouseWheel(new EventArgsMouse(
        ...
        {
            invokeMouseMove(new EventArgsMouse(
                translateWParamIntoMouseButtons(Message.SignedLowWord(message.WParam)),
                0, 
                Message.SignedLowWord(message.LParam), 
                Message.SignedHighWord(message.LParam),
        ...
        {
            // HandleMouseBindings();
            invokeMouseDown(new EventArgsMouse(
                button, 
                clicks, 
                Message.SignedLowWord(message.LParam), 
                Message.SignedHighWord(message.LParam),
        ...
        {
            // HandleMouseBindings();
            invokeMouseUp(new EventArgsMouse(
                button, 
                clicks, 
                Message.SignedLowWord(message.LParam), 
                Message.SignedHighWord(message.LParam),
        ...
        private void invokeMouseWheel(EventArgsMouse e)
        {
            if (MouseWheel != null)
                MouseWheel(e);
        }
        ...
        private void invokeMouseMove(EventArgsMouse e)
        {
            if (MouseMove != null)
                MouseMove(e);
        }
        ...
        private void invokeMouseDown(EventArgsMouse e)
        {
            if (MouseDown != null)
                MouseDown(e);
        }
        ...
        private void invokeMouseUp(EventArgsMouse e)
        {
            if (MouseUp != null)
                MouseUp(e);
        }
        ...
        private void invokeKeyUp(EventArgsKeyboard e)
        {
            if (KeyUp != null)
                KeyUp(e);
        }
        ...
        private void invokeKeyDown(EventArgsKeyboard e)
        {
            if (KeyDown != null)
                KeyDown(e);
        }
        ...
        private void invokeChar(EventArgsKeyboard e)
        {
            if (KeyChar != null)
                KeyChar(e);
        }
