...
namespace UltimaXNA.UI
{
    class Window_ChatInput : Window
    {
        ...
        {
            //Create a new form
            _formCollection.Add(new Form("frmChatInput", string.Empty, new Vector2(400, 24), new Vector2(4, 600 - 24), Form.BorderStyle.None));
            _MyForm = _formCollection["frmChatInput"];
        ...
        {
            UIHelper.Network_SendChat(((Textbox)_MyForm["txtInput"]).Text);
