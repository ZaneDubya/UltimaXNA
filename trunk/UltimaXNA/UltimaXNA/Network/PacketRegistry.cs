...
namespace UltimaXNA.Network
{
    internal static class PacketRegistry
    {
        ...
        internal static void RegisterNetwork(IClientNetwork network)
        {
            ...
            //network.Register<RecvPacket>(0x7C, "Display Menu", -1, OnDisplayMenu); // TODO: Implement packet...DisplayMenuPacket
            network.Register<LoginRejectionPacket>(0x82, "Login Rejection", 2, OnLoginRejection);
            //network.Register<RecvPacket>(0x86, "Character List Update", -1, OnCharacterListUpdate);// TODO: Implement packet...
            ...
            //network.Register<RecvPacket>(0x9E, "Vendor Sell List", -1, OnVendorSellList); // TODO: Implement packet...VendorSellListPacket
            ...
            //network.Register<RecvPacket>(0xA5, "Open Web Browser", -1, OnOpenWebBrowser); // TODO: Implement packet...OpenWebBrowserPacket
            //network.Register<RecvPacket>(0xA6, "Tip/Notice Window", -1, OnTipNoticeWindow); // TODO: Implement packet...ScrollMessagePacket
            ...
            //network.Register<RecvPacket>(0xAA, "Change Combatant", 5, OnChangeCombatant); // TODO: Implement packet...
            network.Register<UnicodeMessagePacket>(0xAE, "Unicode Message", -1, OnUnicodeMessage);
            //network.Register<RecvPacket>(0xAF, "Death Animation", 13, OnDeathAnimation); // TODO: Implement packet...DeathAnimationPacket
            //network.Register<RecvPacket>(0xB0, "Display Gump Fast", -1, OnDisplayGumpFast); // TODO: Implement packet...
            //network.Register<RecvPacket>(0xB7, "Object Help Response ", -1, OnObjectHelpResponse);// TODO: Implement packet...
            network.Register<SupportedFeaturesPacket>(0xB9, "Supported Features", 3, SupportedFeatures);
            //network.Register<RecvPacket>(0xBA, "Quest Arrow", 6, OnQuestArrow);// TODO: Implement packet...
            network.Register<SeasonChangePacket>(0xBC, "Seasonal Change", 3, OnSeasonChange);
            //network.Register<RecvPacket>(0xC0, "Hued Effect", 36, OnHuedEffect);// TODO: Implement packet...
            network.Register<MessageLocalizedPacket>(0xC1, "Message Localized", -1, OnMessageLocalized);
            //network.Register<RecvPacket>(0xC6, "Invalid Map Enable", 1, OnInvalidMapEnable);// TODO: Implement packet...
            //network.Register<RecvPacket>(0xC7, "Particle Effect", 49, OnParticleEffect);// TODO: Implement packet...
            //network.Register<RecvPacket>(0xCB, "Global Que Count", 7, OnGlobalQueCount);// TODO: Implement packet...
            //network.Register<RecvPacket>(0xCC, "Message Localized Affix ", -1, OnMessageLocalizedAffix);// TODO: Implement packet...
            //network.Register<RecvPacket>(0xD3, "Extended 0x78", -1, OnExtended0x78);// QUERY: What is this? TODO: Implement packet...
        ...
        internal static TypedPacketReceiveHandler SupportedFeatures;
        ...
        internal static TypedPacketReceiveHandler OnGlobalQueCount;
