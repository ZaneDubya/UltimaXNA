...
{
	public class Circle : PositionProvider
	{
		...
		public Circle(float radius, bool moveAwayFromCenter)
			: this(radius, moveAwayFromCenter, 0, 0)
		{
		}

		public Circle(float radius, bool moveAwayFromCenter, float rotationX, float rotationY)
		{
			_radius = radius;
		...
		public override Vector3 GetPosition(Vector3 emitterPosition, Vector3 particleMovementDirection)
		{
			...
			ret.Normalize();
			ret *= (float)_random.NextDouble() * _radius;
		...
		{
			get { return EmitterShape.Circle; }
		}
	}
}
