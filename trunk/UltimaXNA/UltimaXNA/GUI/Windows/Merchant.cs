...
namespace UltimaXNA.GUI
{
    class Window_Merchant : Window
    {
        ...
        public Window_Merchant(Entity nContainerObject, FormCollection nFormCollection)
            : base()
        {
            mContainerObject = (Item)nContainerObject;
        ...
        private void btnInv_OnPress(object obj, EventArgs e)
        {
            ...
            Item iItem = mContainerObject.ContainerObject.GetContents(iIndex);
            if (iItem != null)
            {
                // pick the item up!
        ...
        public override void Update()
        {
            ...
            if (mContainerObject.ContainerObject.UpdateTicker != mLastContainerUpdated)
            {
                ...
                {
                    int iItemTypeID = 0;
                    Item iItem = mContainerObject.ContainerObject.GetContents(i + mScrollY * 2);
                    if (iItem != null)
