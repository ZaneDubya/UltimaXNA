    ...
    class LzxDecoder
    {
        ...
        public LzxDecoder(int window)
        {
            ...
            if (window < 15 || window > 21)
                Logging.Fatal("Unsupported Window Size range");
        ...
        public int Decompress(Stream inData, int inLen, Stream outData, int outLen)
        {
            ...
            while (togo > 0)
            {
                ...
                if (m_state.block_remaining == 0)
                {
                    ...
                    switch (m_state.block_type)
                    {
                        ...
                        default:
                            return -1; // TODO thrw proper exception
                    }
                }
                ...
                if (inData.Position > (startpos + inLen))
                {
                    ...
                    if (inData.Position > (startpos + inLen + 2) || bitbuf.GetBitsLeft() < 16) return -1; //TODO thrw proper exception
                }
                ...
                while ((this_run = (int)m_state.block_remaining) > 0 && togo > 0)
                {
                    ...
                    switch (m_state.block_type)
                    {
                        ...
                        case LzxConstants.BLOCKTYPE.UNCOMPRESSED:
                            if ((inData.Position + this_run) > endpos) return -1; //TODO thrw proper exception
            ...
            if (togo != 0) return -1; //TODO thrw proper exception
        ...
        // TODO make returns thrw exceptions
        ...
        // TODO thrw exceptions instead of returns
        ...
        private uint ReadHuffSym(ushort[] table, byte[] lengths, uint nsyms, uint nbits, BitBuffer bitbuf)
        {
            ...
            if ((i = table[bitbuf.PeekBits((byte)nbits)]) >= nsyms)
            {
                ...
                do
                {
                    ...
                    if (j == 0) return 0; // TODO thrw proper exception
