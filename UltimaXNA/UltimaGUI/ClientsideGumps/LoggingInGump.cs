...
namespace UltimaXNA.UltimaGUI.ClientsideGumps
{
    ...
    class LoggingInGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            AddControl(new TextLabelAscii(this, 1, 166, 143, hue, 2, UltimaData.StringList.Entry(3000002)));
            ...
            AddControl(new TextLabelAsciiCropped(this, 2, 166, 143, 308, 308, hue, 2, UltimaData.StringList.Entry(3000016)));
            ...
            AddControl(new TextLabelAsciiCropped(this, 3, 166, 143, 308, 308, hue, 2, UltimaData.StringList.Entry(3000036)));
            ...
            AddControl(new TextLabelAsciiCropped(this, 4, 166, 143, 308, 308, hue, 2, UltimaData.StringList.Entry(3000034)));
            ...
            AddControl(new TextLabelAsciiCropped(this, 5, 166, 143, 308, 308, 1107, 1, UltimaData.StringList.Entry(3000035)));
            ...
            AddControl(new TextLabelAsciiCropped(this, 6, 166, 143, 308, 308, hue, 2, UltimaData.StringList.Entry(3000036)));
            ...
            AddControl(new TextLabelAsciiCropped(this, 7, 166, 143, 308, 308, hue, 2, UltimaData.StringList.Entry(3000004)));
            ...
            AddControl(new TextLabelAsciiCropped(this, 8, 166, 143, 308, 308, hue, 2, UltimaData.StringList.Entry(3000037)));
            ...
            AddControl(new TextLabelAscii(this, 9, 166, 143, hue, 2, UltimaData.StringList.Entry(3000003)));
