...
namespace UltimaXNA.UltimaGUI.ClientsideGumps
{
    ...
    public class LoginGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            AddControl(new TextLabelAscii(this, 0, 254, 305, hue, 2, UltimaData.StringList.Entry(3000038)));
            // Account Name
            AddControl(new TextLabelAscii(this, 0, 181, 346, hue, 2, UltimaData.StringList.Entry(3000099)));
            // Password
            AddControl(new TextLabelAscii(this, 0, 181, 386, hue, 2, UltimaData.StringList.Entry(3000103)));
            // name field
