...
namespace UltimaXNA.InputOld
{
    public class MouseEventArgs : EventArgs
    {
        ...
        readonly MouseButton[] _buttonsDown;
        readonly MouseButton[] _buttonsUp;
        readonly MouseButton[] _buttonsPressed;
        readonly MouseButton[] _buttonsReleased;
        ...
        /// </summary>
        public bool ContainsButtonUp(MouseButton button)
        {
            bool found = false;
        ...
        /// </summary>
        public bool ContainsButtonDown(MouseButton button)
        {
            bool found = false;
        ...
        /// </summary>
        public bool ContainsButtonPressed(MouseButton button)
        {
            bool found = false;
        ...
        /// </summary>
        public bool ContainsButtonReleased(MouseButton button)
        {
            bool found = false;
