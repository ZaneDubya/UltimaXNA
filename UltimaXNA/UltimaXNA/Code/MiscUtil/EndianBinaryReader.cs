...
namespace MiscUtil.IO
{
    ...
    public class EndianBinaryReader : IDisposable
    {
        ...
        /// <summary>
        /// Reads the specified number of chars, returning them in a new char array.
        /// If not enough chars are available before the end of the stream, this
        ...
        public char[] ReadChars(int count)
        {
            ...
            while (index < count)
            {
                ...
                if (read == 0)
                {
                    ...
                    return Encoding.GetChars(copy);
                }
                index += read;
            }
            return Encoding.GetChars(ret);
        }
