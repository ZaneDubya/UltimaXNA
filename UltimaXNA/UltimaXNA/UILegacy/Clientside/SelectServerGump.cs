...
namespace UltimaXNA.UILegacy.Clientside
{
    ...
    class SelectServerGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            // quit button
            AddGumpling(new Button(this, 0, 554, 2, 5513, 5515, 1, 0, (int)SelectServerGumpButtons.QuitButton));
            ((Button)_controls[_controls.Count - 1]).GumpOverID = 5514;

            // Page 1 - select a server
            // back button
            AddGumpling(new Button(this, 1, 586, 435, 5537, 5539, 1, 0, (int)SelectServerGumpButtons.BackButton));
            ((Button)_controls[_controls.Count - 1]).GumpOverID = 5538;
            // forward button
            AddGumpling(new Button(this, 1, 610, 435, 5540, 5542, 1, 0, (int)SelectServerGumpButtons.ForwardButton));
            ...
            AddGumpling(new Button(this, 2, 305, 342, 1150, 1152, 1, 0, (int)SelectServerGumpButtons.BackButton));
