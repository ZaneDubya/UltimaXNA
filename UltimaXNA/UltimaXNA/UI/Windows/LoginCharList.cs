...
namespace UltimaXNA.UI
{
    class Window_CharacterList : Window
    {
        ...
        {
            //Create a new form
            _formCollection.Add(new Form("frmLoginCharList", "Character List", new Vector2(270, 180), new Vector2(250, 200), Form.BorderStyle.Fixed));
            _MyForm = _formCollection["frmLoginCharList"];
