...
namespace UltimaXNA.UI
{
    class Window_CompressedGump : Window
    {
        ...
        {
            //Create a new form
            _formCollection.Add(new Form("frmCompressedGump:" + gumpID, string.Empty, new Vector2(1, 1), new Vector2(x, y), Form.BorderStyle.None));
            _MyForm = _formCollection["frmCompressedGump:" + gumpID];
            ...
            for (int i = 0; i < gumpPieces.Length; i++)
            {
                ...
                switch (arguements[0])
                {
                    ...
                    case "page":
                        ...
                        break;
                    default:
                        UIHelper.Chat_AddLine("GUMP: Unknown piece '" + arguements[0] + "'.");
                        break;
                }
        ...
        {
            UIHelper.Chat_AddLine("GUMP: Unhandled '" + arguements[0] + "'.");
        }
