...
namespace UltimaXNA.UI
{
    class Window_Container : Window
    {
            ...
            : base()
        {
            ...
            _formCollection.Add(new Form(iFormName, "", mWindowSize, new Vector2(800 - 256, 600 - 256), Form.BorderStyle.None));
        ...
        private void btnInv_OnPress(object obj, EventArgs e)
        {
            ...
            if (buttonindex == 0)
            {
                ...
                {
                    UIHelper.DropItemIntoSlot(_containerEntity, iIndex);
                }
                if (item != null)
                {
                    UIHelper.PickUpItem(item);
                }
            }
        ...
        public override void Update()
        {
            ...
            if (_containerEntity.Contents.UpdateTicker != _lastContainerUpdated)
            {
                ...
                {
                    string iBtnName = "btnInv" + i;
                    ((CustomButton)_MyForm[iBtnName]).Texture = UIHelper.ItemIcon(_SlotsItems[i]);
