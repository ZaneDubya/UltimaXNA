...
namespace UltimaXNA.Interface.GUI.HTML
{
    public class HTMLParser_AtomImageGump : HTMLParser_Atom
    {
        ...
        public override int Width
        {
            ...
            get
            {
                ...
                Texture2D gump = UltimaData.Gumps.GetGumpXNA(Value);
                return gump.Width + 1;
            }
        }
        ...
        public Texture2D Texture
        {
            get
            {
                return UltimaData.Gumps.GetGumpXNA(Value);
            }
        }
    ...
    public class HTMLParser_AtomCharacter : HTMLParser_Atom
    {
        public override int Width
        {
            get
            {
                if (Character < 32)
                    return 0;
                return UltimaData.UniText.Fonts[(int)Font].GetCharacter(Character).Width + (Style_IsBold ? 1 : 0) + 1;
            }
        }
        ...
        public override int Height
        {
            get
            {
                return UltimaData.UniText.Fonts[(int)Font].Lineheight;
            }
        }
    ...
    public class HTMLParser_AtomSpan : HTMLParser_Atom
    {
        ...
        {
            _height = UltimaData.UniText.Fonts[(int)Font].Lineheight;
        }
    }
