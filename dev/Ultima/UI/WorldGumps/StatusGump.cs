    ...
    class StatusGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            else
            {
                ...
                m_Labels[(int)MobileStats.ManaCurrent] = (TextLabelAscii)AddControl(new TextLabelAscii(this, 172, 69, 0, 6, m_Mobile.Mana.Current.ToString() + '/' + m_Mobile.Mana.Max.ToString()));
                m_Labels[(int)MobileStats.StaminaCurrent] = (TextLabelAscii)AddControl(new TextLabelAscii(this, 172, 81, 0, 6, m_Mobile.Stamina.Current.ToString() + '/' + m_Mobile.Stamina.Max.ToString()));
                m_Labels[(int)MobileStats.Gold] = (TextLabelAscii)AddControl(new TextLabelAscii(this, 172, 93, 0, 6, m_Mobile.Gold.ToString()));
                m_Labels[(int)MobileStats.WeightCurrent] = (TextLabelAscii)AddControl(new TextLabelAscii(this, 172, 105, 0, 6, m_Mobile.Weight.Current.ToString() + '/' + m_Mobile.Weight.Max.ToString()));
            }
        }
