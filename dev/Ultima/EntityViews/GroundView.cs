    ...
    public class GroundView : AEntityView
    {
            ...
            : base(ground)
        {
            ...
            if (Entity.LandData.TextureID <= 0)
            {
                ...
                DrawArea = new Rectangle(0, Entity.Z * 4, World.Views.IsometricRenderer.TileSizeI, World.Views.IsometricRenderer.TileSizeI);
            }
            else
            {
                DrawFlip = false;
        ...
        private void updateVertexBuffer()
        {
            ...
            m_vertex1_yOffset = new Vector3(World.Views.IsometricRenderer.TileSizeF, 22 - (m_SurroundingTiles.East * 4), 0);
            m_vertex2_yOffset = new Vector3(0, 22 - (m_SurroundingTiles.South * 4), 0);
            m_vertex3_yOffset = new Vector3(22, World.Views.IsometricRenderer.TileSizeF - (m_SurroundingTiles.Down * 4), 0);
