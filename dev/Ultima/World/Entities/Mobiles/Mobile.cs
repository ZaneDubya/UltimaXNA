...
namespace UltimaXNA.Ultima.World.Entities.Mobiles
{
    ...
    public class Mobile : AEntity
    {
        ...
        #region  FOR PARTY SYSTEM
        // for party system
        bool m_OpenedStatus = false;
        public bool QueryStats()
        {
            INetworkClient m_Network = ServiceRegistry.GetService<INetworkClient>();
            m_OpenedStatus = true;
            return m_Network.Send(new PQueryStats(Serial)); ;
        }
        // for party system
        private IMobileStatus m_StatusBar;
        public IMobileStatus StatusBar { get { return this.m_StatusBar; } set { this.m_StatusBar = value; } }
