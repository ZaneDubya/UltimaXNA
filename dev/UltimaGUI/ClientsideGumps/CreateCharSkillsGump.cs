...
namespace UltimaXNA.UltimaGUI.ClientsideGumps
{
    class CreateCharSkillsGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            // title text
            AddControl(new TextLabelAscii(this, 1, 148, 132, 841, 2, UltimaData.StringList.Entry(3000326)));

            // strength, dexterity, intelligence
            AddControl(new TextLabelAscii(this, 1, 158, 170, 2430, 1, UltimaData.StringList.Entry(3000111)));
            AddControl(new TextLabelAscii(this, 1, 158, 250, 2430, 1, UltimaData.StringList.Entry(3000112)));
            AddControl(new TextLabelAscii(this, 1, 158, 330, 2430, 1, UltimaData.StringList.Entry(3000113)));
            ...
            string[] skillList = UltimaData.Skills.ListNames;
