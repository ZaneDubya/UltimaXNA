...
namespace UltimaXNA.UltimaGUI.ClientsideGumps
{
    ...
    class SelectServerGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            AddControl(new HtmlGump(this, 1, 158, 72, 200, 20, 0, 0, UltimaData.StringList.Entry(1044579)));
            AddControl(new HtmlGump(this, 1, 402, 72, 50, 20, 0, 0, UltimaData.StringList.Entry(1044577)));
            AddControl(new HtmlGump(this, 1, 472, 72, 80, 20, 0, 0, UltimaData.StringList.Entry(1044578)));
            ...
            AddControl(new TextLabelAscii(this, 2, 166, 143, 2017, 2, UltimaData.StringList.Entry(3000053) + "..."));
